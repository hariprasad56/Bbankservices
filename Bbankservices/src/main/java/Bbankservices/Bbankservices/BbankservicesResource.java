...
package Bbankservices.Bbankservices;
...
@Path("/resource")
public class BbankservicesResource {
	/*
	...
	static Logger logger = Logger.getLogger(BbankservicesResource.class.getName());
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/Bbankservices/resource"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/Bbankservices/resource/greet?name={name}"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/Bbankservices/resource/{path}/"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/Bbankservices/resource/prop"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/Bbankservices/resource/unprotected"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/Bbankservices/resource/protected"
	 */
